/**
 * ═══════════════════════════════════════════════════════
 * BLOCKVOX — REAL-TIME TRANSPARENCY DASHBOARD
 * ═══════════════════════════════════════════════════════
 * A high-fidelity analytics surface providing public visibility into 
 * the on-chain election state. Synchronized directly with Avalanche Fuji.
 * 
 * CORE ANALYTICS:
 * 1. ON-CHAIN SYNC: Aggregates real-time tallies from the smart contract.
 * 2. AI FRAUD SHIELD: Visualizes protocol integrity monitoring.
 * 3. AUDIT FEED: Human-readable log of verified cryptographic events.
 * ═══════════════════════════════════════════════════════
 */
