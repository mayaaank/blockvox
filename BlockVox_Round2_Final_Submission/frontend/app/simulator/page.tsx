/**
 * ═══════════════════════════════════════════════════════
 * BLOCKVOX — GOVERNANCE & FAIRNESS SIMULATOR
 * ═══════════════════════════════════════════════════════
 * A mathematical sandbox designed to visualize the impact 
 * of different voting sub-protocols on election outcomes.
 * 
 * CORE SIMULATIONS:
 * 1. ARROW'S THEOREM AUDIT: Compares FPTP, Approval, Score, and IRV.
 * 2. VERITASIUM MODE: Models biological and physical intent distribution.
 * 3. QUADRATIC PREVIEW: Conceptualizes the "Passion Matters" credit system.
 * ═══════════════════════════════════════════════════════
 */
